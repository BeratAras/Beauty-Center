...
jQuery(document).on('action.init_hidden_elements', function(e, cont) {
	...
	if (JUDE_STORAGE['button_hover'] && JUDE_STORAGE['button_hover']!='default') {
		jQuery('button:not(.search_submit):not([class*="sc_button_hover_"]),\
				...
				.jude_tabs .jude_tabs_titles li a:not([class*="sc_button_hover_"]),\
		...
		jQuery('.sidebar .trx_addons_tabs .trx_addons_tabs_titles li a:not([class*="sc_button_hover_style_"]),\
				.jude_tabs .jude_tabs_titles li a:not([class*="sc_button_hover_style_"]),\
		...
		jQuery('.sc_price_default .trx_addons_column-1_3:nth-child(2n) .sc_price_item_link:not([class*="sc_button_hover_style_"])\
				').addClass('sc_button_hover_just_init sc_button_hover_style_link2');
		jQuery('.sc_price_default .trx_addons_column-1_3:nth-child(2n+1) .sc_price_item_link:not([class*="sc_button_hover_style_"]),\
				.post_item .more-link\
				').addClass('sc_button_hover_just_init sc_button_hover_style_dark');
		...
		jQuery('.socials_wrap .social_item .social_icon\
				').addClass('sc_button');
		...
		jQuery('.mejs-controls button,\
				...
				').removeClass('sc_button_hover_'+JUDE_STORAGE['button_hover']);
