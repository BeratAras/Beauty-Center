...
if (!function_exists('jude_customizer_get_css')) {

	function jude_customizer_get_css($colors=null, $fonts=null, $remove_spaces=true, $only_scheme='') {
		...
		if ($fonts) {
			...
			$fonts = jude_customizer_add_theme_fonts($fonts);
...
CSS;
			$rez = apply_filters('jude_filter_get_css', $rez, false, $fonts, '');
			$css['fonts'] = $rez['fonts'];
...
CSS;
		...
		//--------------------------------------
		if ($colors !== false) {
			$schemes = empty($only_scheme) ? array_keys(jude_get_list_schemes()) : array($only_scheme);
	
			if (count($schemes) > 0) {
				$rez = array();
				foreach ($schemes as $scheme) {
					// Prepare colors
					if (empty($only_scheme)) $colors = jude_get_scheme_colors($scheme);
	
					// Make theme-specific colors and tints
					$colors = jude_customizer_add_theme_colors($colors);
...
table:not(.booked-calendar):not(.tribe-events-calendar):not(.variations) > tbody > tr:nth-child(2n+1) > th,
table:not(.booked-calendar):not(.tribe-events-calendar):not(.variations) > tbody > tr:nth-child(2n+1) > td {
	background-color: {$colors['bd_color']};
	border-color: {$colors['bg_color']};
}
table:not(.booked-calendar):not(.tribe-events-calendar):not(.variations) > tbody > tr:nth-child(2n) > th,
table:not(.booked-calendar):not(.tribe-events-calendar):not(.variations) > tbody > tr:nth-child(2n) > td {
	background-color: {$colors['alter_bg_color']};
}
table:not(.booked-calendar):not(.tribe-events-calendar):not(.variations) > tbody > tr th {
	border-color: {$colors['alter_bg_color']};
	border-top-color: {$colors['alter_bg_color']};
	
}
table:not(.booked-calendar):not(.tribe-events-calendar):not(.variations) > thead > tr th {
	border-color: {$colors['alter_bg_color']};
	border-top-color: {$colors['alter_bg_color']};
	border-right-color: {$colors['alter_bg_color']};
}
table:not(.booked-calendar):not(.tribe-events-calendar):not(.variations) > thead > tr th:not(:first-child) {
	border-left-color: {$colors['alter_bg_color']};
}

table:not(.booked-calendar):not(.tribe-events-calendar):not(.variations) > tbody > tr td:first-child {border-left-color: {$colors['bg_color']};}
table:not(.booked-calendar):not(.tribe-events-calendar):not(.variations) > tbody > tr td:last-child {border-right-color: {$colors['bg_color']};}
table:not(.booked-calendar):not(.tribe-events-calendar):not(.variations) > tbody > tr:nth-child(2n) td:last-child {border-right-color: {$colors['alter_bg_color']};}
table:not(.booked-calendar):not(.tribe-events-calendar):not(.variations) > tbody > tr:nth-child(2n) td:first-child {border-right-color: {$colors['alter_bg_color']};}
table:not(.booked-calendar):not(.tribe-events-calendar):not(.variations) > tbody > tr:nth-child(2n+1) td:first-child {border-left-color: {$colors['bg_color']};}

table:not(.booked-calendar):not(.tribe-events-calendar):not(.variations) > tbody > tr:first-child th:first-child { 	border-left-color: {$colors['alter_bg_color']};}
table:not(.booked-calendar):not(.tribe-events-calendar):not(.variations) > tbody > tr:first-child th:last-child {	border-right-color: {$colors['alter_bg_color']};}
table:not(.booked-calendar):not(.tribe-events-calendar):not(.variations) > tbody > tr th:last-child {	border-right-color: {$colors['alter_bg_color']};}

table.ui-datepicker-calendar>tbody>tr:nth-child(2n)>td {
...
table a { color: {$colors['text_hover']};}
table a:hover { color: {$colors['text_light']};}
...
textarea[placeholder]::-webkit-input-placeholder	{ color: {$colors['text_hover']}; }
input[placeholder]::-moz-placeholder,
textarea[placeholder]::-moz-placeholder				{ color: {$colors['text_hover']}; }
input[placeholder]:-ms-input-placeholder,
textarea[placeholder]:-ms-input-placeholder			{ color: {$colors['text_hover']}; }
input[placeholder]::placeholder,
textarea[placeholder]::placeholder					{ color: {$colors['text_hover']}; }

.wpcf7-form .sc_form .trx_addons_columns_wrap .prefered-time:before,
.wpcf7-form .sc_form .trx_addons_columns_wrap .prefered-date:before { color: {$colors['text_light']};}
...
.widget.woocommerce a.button + a.button {
	color: {$colors['text_dark']}!important;
	background-color: {$colors['bd_color']};
}
.widget.woocommerce a.button + a.button:hover {
...
.sc_layouts_menu_mobile_button_burger a .sc_layouts_item_icon{
	color: {$colors['bd_color']};
}
.sc_layouts_menu_mobile_button:hover,
.sc_layouts_menu_mobile_button_burger:hover {
	background-color: {$colors['text_dark']};	
}
.sc_layouts_menu_mobile_button:hover a .sc_layouts_item_icon,
.sc_layouts_menu_mobile_button_burger:hover a .sc_layouts_item_icon{
	color: {$colors['bd_color']}!important;
}
...
/* Header */
.top_panel.scheme_default .sc_layouts_row {
	background-color: {$colors['alter_bg_color']};
}
.top_panel.scheme_default.top_panel_custom_header-home2 .sc_layouts_row {background-color: {$colors['bg_color']};}
.top_panel.scheme_default.top_panel_custom_header-front .sc_layouts_row:not(.sc_layouts_row_fixed_on) {
	background-color: transparent;
}


.header_position_over .top_panel.scheme_default .sc_layouts_row:not(.sc_layouts_row_fixed_on){
	background-color: transparent;
}
.home .top_panel.scheme_default .sc_layouts_row:not(.sc_layouts_row_fixed_on) {
	background-color: transparent;
}
.top_panel.scheme_default .sc_layouts_row:last-child {
	background-color: {$colors['bd_color']};
}

.top_panel.scheme_default .top_panel_navi {
	background-color: {$colors['alter_bg_color']};
}
...
.top_panel .sc_layouts_row_fixed_on:after,
.top_panel .sc_layouts_row_fixed_on:before,
.sidebar_show .page_content_wrap:after,
.sidebar_show .page_content_wrap:before{
	background-color: {$colors['bg_color']};
}
.sidebar_show .page_content_wrap .sidebar.scheme_self:before{ background-color: {$colors['alter_bg_color']};}

.top_panel .widget_contacts .contacts_info span:before, 
.top_panel .widget_contacts .contacts_info>div>a:before, 
.top_panel .widget_contacts .contacts_info>a:before {
	color: {$colors['text_hover']};
}
...
.jude_tabs .jude_tabs_titles li a:hover {
	color: {$colors['inverse_link']};
	background-color: {$colors['text_link']};
}
.jude_tabs .jude_tabs_titles li.ui-state-active a {
	color: {$colors['bg_color']};
	background-color: {$colors['text_dark']};
}

div.esg-filter-wrapper .esg-filterbutton {background-color: transparent;}
.mptt-navigation-tabs li a,
div.esg-filter-wrapper .esg-filterbutton > span{color: {$colors['text']};}
.mptt-navigation-tabs li a:hover,
div.esg-filter-wrapper .esg-filterbutton > span:hover {color: {$colors['text_hover']};}
.mptt-navigation-tabs li.active a,
div.esg-filter-wrapper .esg-filterbutton.selected > span{color: {$colors['text_hover']};}
...
.mejs-controls .mejs-time-rail .mejs-time-loaded:before,
.mejs-container .mejs-controls .mejs-horizontal-volume-slider .mejs-horizontal-volume-total:before {
...
/* Single post */
.post_item_single .single_meta_top .post_meta a{
	color: {$colors['text_light']};
}
...
.scheme_self.footer_wrap .wpb_text_column ,
.footer_wrap .scheme_self.vc_row .wpb_text_column {	
	color: {$colors['text_dark']};
}
...
.scheme_self.footer_wrap .footer_menu_wrap:not(:first-child) .footer_menu_inner {
	border-color: {$colors['alter_bd_color']};
}
...
.footer_copyright_wrap .copyright_text a,
.footer_copyright_wrap .copyright_text {
	color: {$colors['text_dark']};
}
.footer_copyright_wrap .copyright_text a:hover {
	color: {$colors['text_hover']};
}

/* Instagramm */
#sb_instagram #sbi_load .sbi_load_btn, #sb_instagram .sbi_follow_btn a i{
	color: {$colors['text_hover']};
}
...
/* custom colors */
.cont3 .wpb_text_column h5{ color: {$colors['text_light']};}
.cont3 .wpb_text_column a{ color: {$colors['text']};}
.cont3 .wpb_text_column a:hover{ color: {$colors['text_hover']};}
...
.slider_elastistack .slider_controls_wrap a{
	background-color: {$colors['text_hover']}!important;
	color: {$colors['bg_color']}!important;
}
...
CSS;
					...
					$rez = apply_filters('jude_filter_get_css', $rez, $colors, false, $scheme);
		...
		return apply_filters( 'jude_filter_prepare_css', $css_str, $remove_spaces );
	}
}
?>