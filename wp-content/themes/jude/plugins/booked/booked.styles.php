...
if (!function_exists('jude_booked_get_css')) {
	add_filter('jude_filter_get_css', 'jude_booked_get_css', 10, 4);
	function jude_booked_get_css($css, $colors, $fonts, $scheme='') {
...
table.booked-calendar td.prev-date {
	border-color: {$colors['bd_color']}!important;
}
...
table.booked-calendar td.prev-date.next-month .date,
table.booked-calendar td.prev-date.next-month:hover .date,
table.booked-calendar td.prev-month .date,
table.booked-calendar td.prev-date.prev-month .date,
table.booked-calendar td.prev-date.prev-month:hover .date {
	background-color: {$colors['bd_color_08']} !important;
	color: {$colors['text_light']} !important;
	border-color: {$colors['bd_color']}!important;
}
table.booked-calendar td.next-month .date span,
table.booked-calendar td.prev-date.next-month .date span,
table.booked-calendar td.prev-date.next-month:hover .date span,
table.booked-calendar td.prev-month .date span,
table.booked-calendar td.prev-date.prev-month .date span,
table.booked-calendar td.prev-date.prev-month:hover .date span{
	color: {$colors['text_light']} !important;
	background-color: {$colors['bd_color_08']} !important;
}
table.booked-calendar td.prev-date.today .date span,
table.booked-calendar td.prev-date.today:hover .date span {
...
table.booked-calendar td .date:hover {
	background-color: {$colors['text_link']} !important;
}
table.booked-calendar td .date:hover span{
	background-color: {$colors['text_hover']} !important;
	color: {$colors['bd_color']} !important;
}
