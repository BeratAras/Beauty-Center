...
if ( !function_exists( 'jude_woocommerce_get_css' ) ) {
	add_filter( 'jude_filter_get_css', 'jude_woocommerce_get_css', 10, 4 );
	function jude_woocommerce_get_css($css, $colors, $fonts, $scheme='') {
...
.single-product ul.products li.product .post_featured:before {
...
/* Shop mode selector */
.jude_shop_mode_buttons a {
	color: {$colors['text_link']};
}
.jude_shop_mode_buttons a:hover {
	color: {$colors['text_hover']};
}
.shop_mode_thumbs .jude_shop_mode_buttons a.woocommerce_thumbs,
...
.woocommerce table.cart.shop_table_responsive tr:last-child td{
...
.woocommerce-page table.cart td.actions input[type='submit']:hover {
...
body.woocommerce-cart .page_content_wrap .content_wrap .content .post_item_single {
	background: {$colors['bd_color']};
}
.woocommerce .checkout #order_review, .woocommerce-page .checkout #order_review {
	background: {$colors['bd_color']};
}
.woocommerce table.shop_table thead tr:not(.cart-subtotal) th {
	background-color: {$colors['text_light']};
}

.product.type-product .trx-stretch-width-wrap {
	background: {$colors['bg_color']};
}
...
.woocommerce table.shop_table tr.second_row:last-child td {
...
.woocommerce .post_featured.hover_shop_buttons  .button.shop_cart:hover,
.woocommerce-page .post_featured.hover_shop_buttons  .button.shop_cart:hover,
.woocommerce  .post_featured.hover_shop_buttons a.button.shop_cart:hover,
.woocommerce-page  .post_featured.hover_shop_buttons a.button.shop_cart:hover{
