...
if (!function_exists('jude_trx_addons_get_css')) {
	add_filter('jude_filter_get_css', 'jude_trx_addons_get_css', 10, 4);
	function jude_trx_addons_get_css($css, $colors, $fonts, $scheme='') {
...
.post_featured .sc_slider_controls .slider_controls_wrap > a,
.post_featured .slider_container.slider_controls_side .slider_controls_wrap > a,
.post_featured .slider_outer_controls_side .slider_controls_wrap > a {
	color: {$colors['text_dark']};
...
.slide_content .sc_item_subtitle {
	color:{$colors['text_link']};
}
.slide_content .sc_item_title,
.slide_content .sc_item_descr {
	color:{$colors['bd_color']};
}

.boxed_slide .slide_content .sc_item_subtitle,
.home .slide_content .sc_item_subtitle {
	color:{$colors['bd_color']};
}
.boxed_slide .slide_content .sc_item_title,
.home .slide_content .sc_item_title,
.boxed_slide .slide_content .sc_item_descr,
.home .slide_content .sc_item_descr {
	color:{$colors['text_dark']};
}
...
.sc_action_item_default.with_image:after {
	background-color:{$colors['inverse_dark_04']};
}
...
.sc_blogger_default .post_meta_item,
.sc_blogger_default .post_meta_item a {
	color: {$colors['text_light']};
}
.sc_blogger_default .post_meta_item.post_author {
	color: {$colors['text_hover']};
}
...
.sc_price_default .sc_price_item_title_{
	color: {$colors['bd_color']};
}
.sc_price_default .trx_addons_column-1_3:nth-child(2n+1) .sc_price_item_price,
.sc_price_default .trx_addons_column-1_3:nth-child(2n+1) .sc_price_item_title_{
	color:{$colors['text_light']};
}
.sc_price_item .sc_price_item_details ul li:not(:last-child) {
	border-color:{$colors['bg_color']};
}
.sc_price_default .sc_price_item.with_image .sc_price_item_mask {
...
.sc_services_light .trx_addons_column-1_3:nth-child(2) .sc_services_item {
	background-color: {$colors['bd_color']};
}
.sc_services_light .sc_services_item a{
	color: {$colors['bd_color']};
}
.sc_services_light .sc_services_item a:hover,
.sc_services_light .trx_addons_column-1_3:nth-child(2) .sc_services_item  a:hover{
	color: {$colors['text_hover']};
}
.sc_services_light .trx_addons_column-1_3:nth-child(2) .sc_services_item  a{
	color: {$colors['text_light']};
}
...
.sc_team_short .trx_addons_hover_content .trx_addons_hover_info a.social_item:hover {
	color: {$colors['bd_color']};
}

.sc_team_light .post_featured .sc_team_item_title a{ color: {$colors['text_dark']};}
.sc_team_light .post_featured .sc_team_item_title a:hover{ color: {$colors['text_hover']};}
...
.sc_team_light.sc_team .sc_team_item_thumb .sc_team_item_socials .social_item:hover{ 
	color: {$colors['bd_color']};
}
...
.trx_addons_popup .trx_addons_popup_form_field input[type='submit']{
	color: {$colors['bd_color']};
}
...
.mptt-shortcode-wrapper.mptt-table-responsive table.mptt-shortcode-table>tbody>tr:nth-child(2n+1)>td,
.mptt-shortcode-wrapper.mptt-table-responsive table.mptt-shortcode-table>tbody>tr:nth-child(2n)>td {
	background-color: {$colors['bg_color']};
}
...
.mptt-shortcode-wrapper.mptt-table-responsive table.mptt-shortcode-table>tbody>tr>td.mptt-shortcode-event.event {
	background-color: {$colors['bd_color']};
}
.mptt-shortcode-wrapper.mptt-table-responsive table.mptt-shortcode-table>tbody>tr>td {
	border-color: {$colors['text_link']};
}
