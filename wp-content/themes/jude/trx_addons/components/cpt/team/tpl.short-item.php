	...
	trx_addons_get_template_part('templates/tpl.featured.php',
								...
								apply_filters('trx_addons_filter_args_featured', array(
												...
												'post_info' => !empty($meta['socials']) 
																	? '<div class="trx_addons_hover_content"><div class="sc_team_item_socials socials_wrap trx_addons_hover_info">'.
																	trim(trx_addons_get_socials_links_custom($meta['socials'], '', 'names'))
																	.'</div><a class="sc_button sc_button_default sc_button_hover_slide_top sc_button_size_small" href="' . esc_url($link) . '">Book now</a></div>'
																	: ''
												), 'team-short')
								);
	?>
