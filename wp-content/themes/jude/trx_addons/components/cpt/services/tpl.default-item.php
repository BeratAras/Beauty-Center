...
?>>
	...
	<div class="sc_services_item_info">
		<div class="sc_services_item_header">
			...
			?></a></h4>
			<?php trx_addons_show_layout(trx_addons_get_post_terms(', ', get_the_ID(), TRX_ADDONS_CPT_SERVICES_TAXONOMY));?>
		...
		<?php if (!isset($args['hide_excerpt']) || $args['hide_excerpt']==0) { ?>
			...
			<?php echo esc_url($link); ?><?php echo esc_attr(apply_filters('trx_addons_filter_sc_item_link_classes', 'sc_button sc_button_simple', 'sc_services', $args)); ?>"><?php esc_html_e('Learn more', 'jude'); ?>
		<?php } ?>
	</div>
</div>
<?php
