...
// Set plugin's specific importer options
if ( !function_exists( 'trx_addons_instagram_feed_filter_export_options' ) ) {
	if (is_admin()) add_filter( 'trx_addons_filter_export_options',	'trx_addons_instagram_feed_filter_export_options' );
	function trx_addons_instagram_feed_filter_export_options($options=array()) {
